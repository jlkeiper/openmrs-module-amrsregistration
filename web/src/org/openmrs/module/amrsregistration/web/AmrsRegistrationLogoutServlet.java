 ...
 * @see Context#logout()
 */
public class AmrsRegistrationLogoutServlet extends HttpServlet {

	public static final long serialVersionUID = 12345692123L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect(request.getContextPath() + "/module/amrsregistration/login.htm");
